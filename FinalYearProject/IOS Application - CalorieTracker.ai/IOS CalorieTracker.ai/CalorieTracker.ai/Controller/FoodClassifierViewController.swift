...
// The code is being taken from a Swift5 tutorial in Udemy website.
// It is also tweaked to suit the needs of the project of acting as a prediction facilitator.
// Link of course: https://www.udemy.com/devslopes-ios12/
...
class FoodClassifierViewController: UIViewController {
    ...
    lazy var classificationRequest: VNCoreMLRequest = {
        do {
            let model = try VNCoreMLModel(for: VisionFeaturePrintScene().model)
